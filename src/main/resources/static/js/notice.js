...
function noticexiugai1() {
    transnoticeid = $("#noticeid1").text();
    console.log(transnoticeid);
    var data = {noticeid:transnoticeid}
    $.ajax({
        type:"POST",
        url:"/cachenoticeid",
        data:data,
...
function noticexiugai2() {
    transnoticeid = $("#noticeid2").text();
    console.log(transnoticeid);
    var data = {noticeid:transnoticeid}
    $.ajax({
        type:"POST",
...
function noticexiugai3() {
    transnoticeid = $("#noticeid3").text();
    console.log(transnoticeid);
    var data = {noticeid:transnoticeid}
    $.ajax({
        type:"POST",
...
function noticexiugai4() {
    transnoticeid = $("#noticeid4").text();
    console.log(transnoticeid);
    var data = {noticeid:transnoticeid}
    $.ajax({
        type:"POST",
...
function inittransnoticehtml() {
    $.ajax({
        ...
        success: function (alldata) {
            console.log(alldata);
            $("#transnoticetitle").val(alldata['noticetitle']);
            $("#transnoticecontent").val(alldata['noticecontent']);
        }
    })
}

function noticexiugaibtn() {

    var newnoticetitle = $("#transnoticetitle").val();
    var newnoticecontent = $("#transnoticecontent").val();
    var date = {title:newnoticetitle,content:newnoticecontent};
    $.ajax({
        type: "POST",
        url: "/Administartor/changenotice",
        data: date,
        success: function (alldata) {
            if (alldata['status'] == 1) {
...
function noticeshanchu1() {
    transnoticeid = $("#noticeid1").text();
    console.log(transnoticeid);
    var data = {noticeid:transnoticeid}
    $.ajax({
        type:"POST",
        url:"/Administartor/deletenotice",
        data:data,
        success: function (alldata) {
            if(alldata['status']==1){
                alert(alldata['message']);
...
function addnoticebtn() {
    var newnoticetitle = $("#addnoticetitle").val();
    var newnoticecontent = $("#addnoticecontent").val();
    var data = {title:newnoticetitle,content:newnoticecontent};
    $.ajax({
        type: "POST",
        url: "/Administartor/addnotice",
        data: data,
        success: function (alldata) {
            if (alldata['status'] == 1) {
                alert(alldata['message']);
